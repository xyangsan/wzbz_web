  ...
  <div class="xz-tip-set">
    ...
    <div class="xz-tip-content">
      ...
      <div class="xz-tip-content-title3">
        ...
        <span class="xz-tip-value2">（人工选择格局）</span>
        <img :src="require('@/assets/images/icon_record.png')" class="icon" @click="navToSetting"/>
        <lable class="edit" @click="navToSetting">(编辑)</lable>
      </div>
      ...
      <div class="xz-tip-content-tip">
        <span>
          判断格局是八字核心技法之一，目前问真的系统评估准确率在90%以上，机器算法如有误差，专业命理师可自定义格局，此功能与断事笔记的格局选择一键同步。
        </span>
      </div>
      <div class="xz-tip-setting" @click="navToSetting">
        <img :src="require('@/assets/images/ganzhi/icon_ganzhi_setting.png')"/>
        <span >格局设置</span>
      </div>
    </div>
