<template>
  <div class="container hiddenScrollbar" style="flex: 1">
    <div class="pro-pan-content" ref="container">
      <!-- :style="{ minHeight: containerHeight + 'px' }" -->
      <div class="pro-pan-content-right">
        <div class="pro-pan-content-bg">
          ...
          <div class="pro-pan-qiyun">
            ...
            <div class="pro-pan-qiyun-right">
              <!-- <div class="left">{{ yunDatas.riKWStr }}空亡（日）</div> -->
              <div class="right">
                <div class="age">
          ...
          <div class="pro-pan-yun" v-if="panDatas.isLiuNian == 1 && !isHideLiuNian">
            ...
            <div class="pro-pan-yun-items">
              <div
                ...
                :key="lnIndex"
                :class="{
                  'pro-pan-yun-item-selected': liunianIndex === lnIndex,
                }"
          ...
          >
            已选日期：{{ yunDatas.liuriArr[liuriIndex - 1][5] }}
            {{ yunDatas.liuriArr[liuriIndex - 1][7]
            }}{{
              isClickLiuShi
                ? ' ' + yunDatas.liushiArr[liushiIndex - 1][1] + '时'
                : ''
            }}（阴历：{{ yunDatas.liuriArr[liuriIndex - 1][6] }}）
          </div>
        </div>
        <!-- 五行 -->
...
.container {
  ...
  .pro-pan-content {
    ...
    .pro-pan-qiyun {
      ...
      border-bottom-left-radius: 15px;
      border-bottom-right-radius: 15px; // border-top: 1px solid rgba(240, 240, 240, 100);
      // background-color: white;
      font-size: 12px;
      color: #101010;
